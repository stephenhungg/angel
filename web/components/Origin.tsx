...
const slides = [
  {
    label: "01",
    headline: "she's a presence, not an app.",
    quote: "i usually don't trust ai. she felt different.",
    quoteImg: "/kawaii/mascot-wave.png",
    metaLabel: "Shot in",
    metaValue: "Berkeley",
    viewLabel: "see archetypes",
    viewHref: "#archetypes",
    portrait: "/kawaii/presence-pink.png",
  },
  {
    label: "02",
    headline: "every conversation she remembers — across every session.",
    quote: "she opens with the thing i was afraid to say.",
    quoteImg: "/kawaii/mascot-phone.png",
    metaLabel: "Memory",
    metaValue: "6-layer model",
    viewLabel: "see how memory works",
    viewHref: "#what-she-is",
    portrait: "/kawaii/memory-pink.png",
  },
  {
    label: "03",
    headline: "she ships your code. honestly.",
    quote: "watching her walk to the desk is the first time an agent has felt like a coworker.",
    quoteImg: "/kawaii/mascot-wave.png",
    metaLabel: "Agency",
    metaValue: "sonnet 4.6",
    viewLabel: "see her stack",
    viewHref: "#what-she-is",
    portrait: "/kawaii/agency-pink.png",
  },
  {
    label: "04",
    headline: "close the laptop, text her — she's still there.",
    quote: "i closed the laptop expecting her to die. she texted me from oslo.",
    quoteImg: "/kawaii/mascot-phone.png",
    metaLabel: "Continuity",
    metaValue: "sms + cloud",
    viewLabel: "download angel",
    viewHref: "/download",
    portrait: "/kawaii/continuity-pink.png",
  },
];
