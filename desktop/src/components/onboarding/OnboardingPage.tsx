/**
 * OnboardingPage — entry into the 3-round swipe flow.
 * Ported from web/app/swipe/page.tsx. onComplete fires when the
 * 3rd round finishes; App.tsx then transitions into RevealOverlay.
 */
...
export function OnboardingPage({ onComplete }: OnboardingPageProps) {
  ...
  // unlock the Web Audio context on first pointer gesture (Chromium policy).
  // RoomShell normally handles this, but it doesn't mount until after reveal.
  useEffect(() => {
  ...
  return (
    <main className="onboarding-root min-h-screen kawaii-bg text-ink-near flex flex-col relative overflow-hidden">
